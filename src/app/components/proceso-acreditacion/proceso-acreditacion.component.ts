...
import { DocumentosRequeridosComponent } from './documentos-requeridos/documentos-requeridos.component';
import { EstadoTramiteComponent } from './estado-tramite/estado-tramite.component';

@Component({
  selector: 'app-proceso-acreditacion',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './proceso-acreditacion.component.html',
  styleUrls: ['./proceso-acreditacion.component.scss']
})
export class ProcesoAcreditacionComponent implements OnInit {
  establecimiento: any = {};
  tramite: string = '';
